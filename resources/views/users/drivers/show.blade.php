...
{!! Form::model($user, ['route' => ['admin-client.update', $user->id], 'method' => 'PUT', 'id' => 'form-modal', 'class' => 'form-horizontal form-label-left']) !!}
  ...
  <div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="@lang('app.phone_mobile')">@lang('app.phone_mobile') 
    </label>
    <div class="col-md-6 col-sm-6 col-xs-12">
    {!! Form::text('mobile', $phones['phone_mobile'], ['class' => 'form-control col-md-7 col-xs-12', 'id' => 'mobile', 'disabled' => 'true']) !!}
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
    {!! Form::text('telephone', $phones['phone_home'], ['class' => 'form-control col-md-7 col-xs-12', 'id' => 'telephone', 'disabled' => 'true']) !!}
    </div>
  </div>
