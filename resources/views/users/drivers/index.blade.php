    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <p>
            <button type="button" data-href="{{ route('user.create', 'role=false') }}" class="btn btn-primary btn-sm create-edit-show" data-model="modal" title="@lang('app.create_driver')">@lang('app.create_driver')</button>
            </p>
