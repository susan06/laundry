...
{!! Form::model($user, ['route' => ['profile.update', $user->id], 'method' => 'PUT', 'id' => 'form-modal', 'class' => 'form-horizontal form-label-left']) !!}
  ...
  <div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="@lang('app.mobile')">@lang('app.phone_mobile') <span class="required">*</span>
    </label>
  ...
  <div class="form-group">
    ...
    <div class="col-md-4 col-sm-4 col-xs-12">
    {!! Form::text('phone_home', $phones['phone_home'], ['class' => 'form-control col-md-7 col-xs-12 phones', 'id' => 'telephone', 'data-inputmask' => "'mask' : '999999999'"]) !!}
    </div>
  </div>
</div>
