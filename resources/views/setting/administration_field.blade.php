{!! Form::open(['route' => 'setting.update', 'class' => 'form-horizontal form-label-left']) !!}
  ...
  <div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="@lang('app.coin')">@lang('app.penalty_total') <span class="required">*</span>
    </label>
    <div class="col-md-4 col-sm-4 col-xs-12">
    {!! Form::text('penalty', Settings::get('penalty'), ['class' => 'form-control col-md-7 col-xs-12']) !!}
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-md-4 col-sm-4 col-xs-12">
    {!! Form::text('coin', Settings::get('coin'), ['class' => 'form-control col-md-7 col-xs-12']) !!}
    </div>
  </div>
  <div class="form-group">
