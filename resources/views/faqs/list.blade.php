    ...
    <tbody>
        @foreach ($faqs as $key => $faq)
            <tr>
                ...
                <button type="button" data-href="{{ route('admin-faq.show', $faq->id) }}" class="btn btn-round btn-primary create-edit-show" data-model="modal"
                     title="@lang('app.show_faq')" data-toggle="tooltip" data-placement="top">
                      <i class="fa fa-eye"></i>
                  </button>
                  <button type="button" data-href="{{ route('admin-faq.edit', $faq->id) }}" class="btn btn-round btn-primary create-edit-show" data-model="modal"
                     title="@lang('app.edit_faq')" data-toggle="tooltip" data-placement="top">
                      <i class="fa fa-edit"></i>
                  </button>
                @if($faq->status == 'No Published')
                    <button type="button" data-href="{{ route('admin-faq.destroy', $faq->id) }}" 
