<div class="modal-body">
 {!! Form::open(['route' => ['branch-office.order.incomplete.update', $order->id], 'id' => 'form-modal-reason', 'method' => 'post', 'class' => 'form-horizontal form-label-left']) !!}
...
<div class="modal-footer">
  <button type="submit" class="btn btn-primary btn-submit-reason col-sm-2 col-xs-6">@lang('app.save')</button>
